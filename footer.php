...
if (isset($_SESSION['user_id'])) {
    ...
    if (!$stmt->execute()) {
        ...
        $tier_id = $stmt->get_result()->fetch_assoc()['tier_id'] ?? null;
    }
    $stmt->close();
}
?>
...
<footer class="bg-gray-900 text-white py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <div class="text-2xl font-['Pacifico'] text-white mb-4">WealthGrow</div>
                <p class="text-gray-400 mb-4">Empowering financial freedom through network marketing since 2022.</p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <li><a href="./write_article.php" class="text-gray-400 hover:text-white">Write Article</a></li>
                        <?php if ($tier_id == 3): ?>
                            <li><a href="./add_books.php" class="text-gray-400 hover:text-white">Add Books</a></li>
                        <?php endif; ?>
                    <?php else: ?>
                        <li><a href="./register.php" class="text-gray-400 hover:text-white">Sign Up</a></li>
                        <li><a href="./login.php" class="text-gray-400 hover:text-white">Log In</a></li>
                    <?php endif; ?>
                </ul>
            </div>
            <div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-400">M-Pesa Till: 4178866</span>
                    </li>
                </ul>
            </div>
        </div>
        <div class="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-400 text-sm">© 2025 WealthGrow. All rights reserved.</p>
        </div>
    </div>
</footer>
